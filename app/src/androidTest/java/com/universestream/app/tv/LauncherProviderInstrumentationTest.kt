...
class LauncherProviderInstrumentationTest {
    ...
    private fun resourceArtworkUri(): Uri =
        Uri.parse("android.resource://${context.packageName}/${com.universestream.app.R.mipmap.ic_launcher_vault}")

    private fun mainActivityIntentUri(): String =
        Intent(context, com.universestream.app.MainActivity::class.java)
