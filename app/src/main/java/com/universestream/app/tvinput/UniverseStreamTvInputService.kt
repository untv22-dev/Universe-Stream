package com.universestream.app.tvinput
...
@AndroidEntryPoint
class UniverseStreamTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = UniverseStreamSession(this)

    private inner class UniverseStreamSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "UniverseStreamTvInput"
        const val DEFAULT_USER_AGENT = "UniverseStreamTvInput"
