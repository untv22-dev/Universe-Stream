...
object UniverseStreamPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.universestream.plugin.API"
    const val META_MANIFEST_JSON = "com.universestream.plugin.MANIFEST_JSON"
    const val META_ID = "com.universestream.plugin.ID"
    const val META_NAME = "com.universestream.plugin.NAME"
    const val META_VERSION_NAME = "com.universestream.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.universestream.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.universestream.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.universestream.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.universestream.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.universestream.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.universestream.plugin.PROVIDER_NAME"
