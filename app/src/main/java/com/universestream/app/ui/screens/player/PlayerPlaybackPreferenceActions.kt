 ...
 * The [formatUrl] is one of the [com.universestream.domain.model.ChannelQualityOption.url] values
 * from the channel's [com.universestream.domain.model.Channel.qualityOptions].
 */
