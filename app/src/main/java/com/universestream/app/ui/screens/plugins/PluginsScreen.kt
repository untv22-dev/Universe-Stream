package com.universestream.app.ui.screens.plugins
...
import com.universestream.app.plugins.InstalledUniverseStreamPlugin
import com.universestream.app.plugins.PluginConfigurationAction
import com.universestream.app.plugins.PluginConfigurationField
import com.universestream.app.plugins.PluginConfigurationSection
            ...
            if (configuration != null) {
                ...
                LazyColumn(
                    ...
                    if (uiState.plugins.isEmpty() && !uiState.isLoading) {
                        item {
                            Text(
                                text = "No compatible UniverseStream plugins are installed.",
...
private fun PluginInstallPanel(
    ...
    Column(
        ...
        Text(
            text = "Manual installs are detected when this screen refreshes. Compatible plugins expose the UniverseStream plugin service.",
            style = MaterialTheme.typography.bodySmall,
...
private fun PluginInstallUrlDialog(
    ...
    PremiumDialog(
        ...
        subtitle = "Enter the direct APK URL. UniverseStream will download it and open the installer.",
        onDismissRequest = {
            keyboardController?.hide()
