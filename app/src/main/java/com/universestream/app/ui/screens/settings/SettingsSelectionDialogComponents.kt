...
import com.universestream.app.ui.components.dialogs.rememberDialogOpenGestureBlocker
...
internal fun PremiumSelectionDialog(
    ...
    val isTelevisionDevice = com.universestream.app.device.rememberIsTelevisionDevice()
