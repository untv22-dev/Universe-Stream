...
import com.universestream.app.ui.components.shell.ContentMetadataStrip
...
import com.universestream.app.ui.components.dialogs.HiddenCategoriesDialog
import com.universestream.app.ui.components.dialogs.HiddenChannelsDialog
...
import com.universestream.app.ui.remote.LiveBrowseRemoteShortcutHandler
import com.universestream.app.ui.remote.dispatchLiveBrowseRemoteShortcut
import com.universestream.app.ui.remote.remoteColorButtonForKeyCode
                            ...
                            val handler = when (val target = focusedRemoteShortcutTarget) {
                                ...
                                is FocusedRemoteShortcutTarget.CategoryTarget -> {
                                    ...
                                    if (isLockedCategory && action in setOf(
                                            com.universestream.domain.model.RemoteShortcutAction.PIN_CATEGORY,
                                            com.universestream.domain.model.RemoteShortcutAction.HIDE_CATEGORY
                                        )
                                    ) {
                                        null
                                    } else {
