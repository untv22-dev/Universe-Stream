...
internal fun observeSettingsPreferenceSnapshot(
    ...
    return combine(
        ...
        SettingsPreferenceSnapshot(
            ...
            playerSurfaceMode = com.universestream.domain.model.PlayerSurfaceMode.AUTO,
            ...
            remoteShortcutPreferences = com.universestream.domain.model.RemoteShortcutPreferences(),
