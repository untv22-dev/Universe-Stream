...
internal fun PlayerViewModel.changeChannel(index: Int, isAutoFallback: Boolean = false) {
    ...
    viewModelScope.launch {
        ...
        playerEngine.playbackState
            .filter {
                it == com.universestream.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: com.universestream.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): com.universestream.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): com.universestream.domain.model.Channel? {
...
internal fun PlayerViewModel.resolveChannelNumber(
    channel: com.universestream.domain.model.Channel,
    index: Int
