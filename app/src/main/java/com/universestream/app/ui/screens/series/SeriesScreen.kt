...
import com.universestream.app.ui.components.CategoryRow
import com.universestream.app.ui.components.ContinueWatchingRow
import com.universestream.app.ui.components.SavedCategoryContextCard
import com.universestream.app.ui.components.SavedCategoryShortcut
import com.universestream.app.ui.components.SavedCategoryShortcutsRow
import com.universestream.app.ui.components.SelectionChip
import com.universestream.app.ui.components.SelectionChipRow
import com.universestream.app.ui.components.SeriesCard
...
import com.universestream.app.ui.components.ReorderTopBar
import com.universestream.app.ui.components.dialogs.DeleteGroupDialog
import com.universestream.app.ui.components.dialogs.RenameGroupDialog
import com.universestream.app.ui.components.shell.BrowseHeroPanel
import com.universestream.app.ui.components.shell.BrowseSearchLaunchCard
import com.universestream.app.ui.components.shell.LoadMoreCard
import com.universestream.app.ui.components.shell.InfiniteScrollEffect
...
import com.universestream.app.ui.components.shell.VodActionChip
import com.universestream.app.ui.components.shell.VodActionChipRow
import com.universestream.app.ui.components.shell.VodCategoryOption
import com.universestream.app.ui.components.shell.VodCategoryPickerDialog
import com.universestream.app.ui.components.shell.VodBrowseOptionsDialog
import com.universestream.app.ui.components.shell.VodClassicCategoryOption
import com.universestream.app.ui.components.shell.VodClassicContentHeader
import com.universestream.app.ui.components.shell.VodClassicSplitLayout
import com.universestream.app.ui.components.shell.VodHeroStrip
import com.universestream.app.ui.components.shell.VodSectionHeader
...
import com.universestream.app.ui.screens.vod.HandleVodUserMessage
import com.universestream.app.ui.screens.vod.ProtectedVodPinDialog
import com.universestream.app.ui.screens.vod.VodBrowseDefaults
import com.universestream.app.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        } else if (!isTelevisionDevice && uiState.isVodSyncPending && uiState.selectedCategory == null && uiState.seriesByCategory.isEmpty() && uiState.libraryCount == 0 && uiState.searchQuery.isBlank()) {
            Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                Column(
                    horizontalAlignment = Alignment.CenterHorizontally,
                    verticalArrangement = Arrangement.spacedBy(16.dp)
        ...
        } else if (!uiState.hasActiveProvider || (uiState.selectedCategory == null && uiState.seriesByCategory.isEmpty() && uiState.libraryCount == 0 && uiState.searchQuery.isBlank() && !uiState.isLoadingPreviewRows && (isTelevisionDevice || !uiState.isVodSyncPending))) {
            Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                AppMessageState(
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        com.universestream.app.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        com.universestream.app.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
                        ...
                        if (topRatedSeries.isNotEmpty()) {
                            add(
                                VodActionChip(
                                    ...
                                    detail = stringResource(R.string.vod_picks_count, topRatedSeries.size),
                        ...
                        if (freshSeries.isNotEmpty()) {
                            add(
                                VodActionChip(
                                    ...
                                    detail = stringResource(R.string.vod_picks_count, freshSeries.size),
                                    onClick = onOpenFresh
                                )
                            )
                        }
