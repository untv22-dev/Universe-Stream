...
-keepclassmembers class com.universestream.data.remote.** { <fields>; }
...
-keep class com.universestream.domain.model.** { *; }
-keep class com.universestream.data.local.entity.** { *; }
-keep class com.universestream.data.remote.xtream.model.** { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.universestream.data.security.CredentialCrypto
-keepclassmembers class com.universestream.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}
