...
class UniverseStreamDatabaseMigrationTest {

    private val testDbName = "universestream-migration-test"
    ...
    fun migrate1To42_fullChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("universestream-full-chain-test", 1).close()

        migrationTestHelper.runMigrationsAndValidate(
            "universestream-full-chain-test",
            42,
            true,
    ...
    fun migrate44To51_publicMasterUpgradeValidatesLatestSchema() {
        migrationTestHelper.createDatabase("universestream-public-master-44-51-test", 44).apply {
            execSQL(
                """
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-public-master-44-51-test",
            52,
            true,
    ...
    fun migrate48To49_addsProviderHttpProfileColumns() {
        migrationTestHelper.createDatabase("universestream-48-49-test", 48).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate49To50_createsXtreamLiveOnboardingStateTable() {
        migrationTestHelper.createDatabase("universestream-49-50-test", 49).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-49-50-test",
            50,
            true,
            UniverseStreamDatabase.MIGRATION_49_50
        )
    ...
    fun migrate50To51_addsXtreamLiveOnboardingProfileDiagnostics() {
        migrationTestHelper.createDatabase("universestream-50-51-test", 50).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-50-51-test",
            51,
            true,
            UniverseStreamDatabase.MIGRATION_50_51
        )
    ...
    fun migrate51To52_addsXtreamLiveSyncMode() {
        migrationTestHelper.createDatabase("universestream-51-52-test", 51).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-51-52-test",
            52,
            true,
            UniverseStreamDatabase.MIGRATION_51_52
        )
    ...
    fun migrate52To53_addsStalkerHardeningHydrationColumns() {
        migrationTestHelper.createDatabase("universestream-52-53-test", 52).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-52-53-test",
            53,
            true,
    ...
    fun migrate53To54_addsStalkerIdentityColumns() {
        migrationTestHelper.createDatabase("universestream-53-54-test", 53).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate40To41_addsAudioVideoOffsetColumn() {
        migrationTestHelper.createDatabase("universestream-40-41-test", 40).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-40-41-test",
            41,
            true,
            UniverseStreamDatabase.MIGRATION_40_41
        )
    ...
    fun migrate41To42_createsPlaybackCompatibilityRecordsTable() {
        migrationTestHelper.createDatabase("universestream-41-42-test", 41).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-41-42-test",
            42,
            true,
            UniverseStreamDatabase.MIGRATION_41_42
        )
    ...
    fun migrate42To43_addsProviderSeriesIdColumn() {
        migrationTestHelper.createDatabase("universestream-42-43-test", 42).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-42-43-test",
            43,
            true,
            UniverseStreamDatabase.MIGRATION_42_43
        )
    ...
    fun migrate43To44_addsPagedVodHydrationColumns() {
        migrationTestHelper.createDatabase("universestream-43-44-test", 43).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-43-44-test",
            44,
            true,
            UniverseStreamDatabase.MIGRATION_43_44
        )
    ...
    fun migrate38To39_addsStalkerProviderColumnsAndUniqueIndex() {
        migrationTestHelper.createDatabase("universestream-38-39-test", 38).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate32To33_backfillsMovieWatchCountAndAddsGlobalFavoritesIndex() {
        migrationTestHelper.createDatabase("universestream-32-33-test", 32).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate33To34_addsSuccessTimestampsAndProgramsEndTimeIndex() {
        migrationTestHelper.createDatabase("universestream-33-34-test", 33).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate44To45_dedupesGlobalFavoritesAndAddsNullSafeUniqueKey() {
        migrationTestHelper.createDatabase("universestream-44-45-test", 44).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate45To46_rebuildsSeriesStageWithProviderSeriesKey() {
        migrationTestHelper.createDatabase("universestream-45-46-test", 45).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate46To47_createsBrowseQueryIndexes() {
        migrationTestHelper.createDatabase("universestream-46-47-test", 46).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-46-47-test",
            47,
            true,
            UniverseStreamDatabase.MIGRATION_46_47
        )
    ...
    fun migrate47To48_createsXtreamIndexBackfillsRowsAndMarksSummaryState() {
        migrationTestHelper.createDatabase("universestream-47-48-test", 47).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate34To35_createsSearchHistoryTable() {
        migrationTestHelper.createDatabase("universestream-34-35-test", 34).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-34-35-test",
            35,
            true,
            UniverseStreamDatabase.MIGRATION_34_35
        )
    ...
    fun migrate31To32_scopesFavoritesAndSplitsMixedProviderGroups() {
        migrationTestHelper.createDatabase("universestream-31-32-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate31To32_assignsLegacyGroupsWhenNoProviderIsActive() {
        migrationTestHelper.createDatabase("universestream-31-32-no-active-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-31-32-no-active-test",
            32,
            true,
            UniverseStreamDatabase.MIGRATION_31_32
        )
    ...
    fun migrate35To36_addsProgramRemindersAndEpgMatchMetadata() {
        migrationTestHelper.createDatabase("universestream-35-36-test", 35).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-35-36-test",
            36,
            true,
            UniverseStreamDatabase.MIGRATION_35_36
        )
    ...
    fun migrate36To37_createsTmdbIdentityTable() {
        migrationTestHelper.createDatabase("universestream-36-37-test", 36).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate14To15_addsAuditCompletionColumns() {
        migrationTestHelper.createDatabase("universestream-14-15-test", 14).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate59To60_addsDownloadSourceColumns() {
        migrationTestHelper.createDatabase("universestream-59-60-test", 59).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-59-60-test",
            60,
            true,
    ...
    fun migrate57To61_upgradeChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("universestream-57-61-test", 57).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-57-61-test",
            61,
            true,
    ...
    fun migrate60To61_release114To115UpgradePreservesProviders() {
        migrationTestHelper.createDatabase("universestream-release-114-115-test", 60).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
        ...
        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-release-114-115-test",
            61,
            true,
            UniverseStreamDatabase.MIGRATION_60_61
        )
    ...
    fun migrate60To61_addsStalkerAdvancedOptionsJson() {
        migrationTestHelper.createDatabase("universestream-60-61-test", 60).close()

        val migratedDb = migrationTestHelper.runMigrationsAndValidate(
            "universestream-60-61-test",
            61,
            true,
            UniverseStreamDatabase.MIGRATION_60_61
        )
