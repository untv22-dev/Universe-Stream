...
class OkHttpXtreamApiServiceTest {
    ...
    fun `get applies request profile user agent`() = runTest {
        ...
        service.getLiveCategories(
            ...
            requestProfile = HttpRequestProfile(userAgent = "UniverseStreamTest/1.0", ownerTag = "provider:7/xtream")
        )

        assertThat(seenUserAgent).isEqualTo("UniverseStreamTest/1.0")
    }
