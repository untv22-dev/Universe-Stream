...
class RecordingAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_START_RECORDING = "com.universestream.data.recording.action.START"
        const val ACTION_STOP_RECORDING = "com.universestream.data.recording.action.STOP"
