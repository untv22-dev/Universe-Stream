...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.universestream.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.universestream.domain.model.Result.Success -> Result.success()
            is com.universestream.domain.model.Result.Error -> Result.retry()
            com.universestream.domain.model.Result.Loading -> Result.retry()
        }
    }
