...
import com.universestream.data.local.dao.RecordingRunDao
import com.universestream.data.local.dao.RecordingScheduleDao
import com.universestream.data.local.dao.RecordingStorageDao
import com.universestream.data.local.entity.RecordingRunEntity
import com.universestream.data.local.entity.RecordingScheduleEntity
import com.universestream.data.local.entity.RecordingStorageEntity
import com.universestream.data.manager.recording.CaptureProgress
import com.universestream.data.manager.recording.HlsLiveCaptureEngine
import com.universestream.data.manager.recording.RecordingAlarmScheduler
import com.universestream.data.manager.recording.RecordingForegroundService
import com.universestream.data.manager.recording.RecordingOutputTarget
import com.universestream.data.manager.recording.RecordingServiceLauncher
import com.universestream.data.manager.recording.RecordingSourceResolver
import com.universestream.data.manager.recording.ResolvedRecordingSource
import com.universestream.data.manager.recording.TsPassThroughCaptureEngine
import com.universestream.data.manager.recording.UnsupportedRecordingException
import com.universestream.data.preferences.PreferencesRepository
import com.universestream.data.manager.recording.asPersistenceValues
import com.universestream.data.manager.recording.createOutputTarget
import com.universestream.data.manager.recording.deleteOutputTarget
import com.universestream.data.manager.recording.headersFromJson
import com.universestream.data.manager.recording.headersToJson
import com.universestream.data.manager.recording.inferFailureCategory
import com.universestream.data.manager.recording.resolveStorageDetails
import com.universestream.data.manager.recording.sanitizeRecordingFileName
import com.universestream.data.manager.recording.toEntity
import com.universestream.data.manager.recording.toDomain
import com.universestream.domain.manager.RecordingManager
import com.universestream.domain.model.RecordingFailureCategory
...
import com.universestream.domain.model.RecordingSourceType
...
private const val FAILURE_NOTIFICATION_CHANNEL_ID = "universestream_recording_failure"
