...
import com.universestream.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import com.universestream.data.remote.stalker.StalkerPlaybackResolutionException
import com.universestream.data.remote.stalker.StalkerStreamKind
...
import com.universestream.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is com.universestream.domain.model.Result.Success -> resolvedResult.data
                    is com.universestream.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = com.universestream.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: com.universestream.data.remote.stalker.StalkerPlaybackInfo
    ) {
