...
import com.universestream.data.sync.ContentCachePolicy
import com.universestream.data.sync.SyncManager
import com.universestream.data.util.MoviePresentationSettings
import com.universestream.data.util.buildPresentedMovies
import com.universestream.data.util.rankSearchResults
import com.universestream.data.util.toFtsPrefixQuery
...
import com.universestream.domain.model.Result.Success
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private suspend fun loadPresentationCandidates(movie: Movie): List<com.universestream.data.local.entity.MovieEntity> {
    ...
    private fun com.universestream.data.local.entity.MovieEntity.hasFreshXtreamDetails(now: Long = System.currentTimeMillis()): Boolean {
