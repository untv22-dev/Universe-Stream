...
import com.universestream.data.epg.EpgNameNormalizer
import com.universestream.data.epg.EpgResolutionEngine
import com.universestream.data.local.DatabaseTransactionRunner
import com.universestream.data.local.dao.ChannelEpgMappingDao
import com.universestream.data.local.dao.EpgChannelDao
import com.universestream.data.local.dao.EpgProgrammeDao
import com.universestream.data.local.dao.EpgSourceDao
import com.universestream.data.local.dao.ProviderDao
import com.universestream.data.local.dao.ProviderEpgSourceDao
import com.universestream.data.local.entity.ChannelEpgMappingEntity
import com.universestream.data.local.entity.EpgChannelEntity
import com.universestream.data.local.entity.EpgProgrammeEntity
import com.universestream.data.local.entity.EpgSourceEntity
import com.universestream.data.local.entity.ProviderEpgSourceEntity
import com.universestream.data.mapper.toDomain
import com.universestream.data.preferences.PreferencesRepository
import com.universestream.domain.model.EpgMatchType
import com.universestream.domain.model.EpgOverrideCandidate
import com.universestream.domain.model.EpgSourceType
...
import com.universestream.domain.model.ChannelEpgMapping
...
import com.universestream.domain.model.ProviderEpgSourceAssignment
        ...
        transactionRunner.inTransaction {
            ...
            epgSourceDao.insert(
                EpgSourceEntity(
                    ...
                    url = "universestream://epg-source-staging/${source.id}",
                    enabled = false,
