package com.universestream.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.universestream.data.local.entity.*
import com.universestream.data.remote.stalker.StalkerPlaybackDescriptor
...
import com.universestream.domain.model.*
...
fun CategoryEntity.toDomain() = com.universestream.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun com.universestream.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { com.universestream.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(com.universestream.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = com.universestream.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.universestream.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.universestream.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    com.universestream.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun com.universestream.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = com.universestream.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = com.universestream.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { com.universestream.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(com.universestream.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { com.universestream.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun com.universestream.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
