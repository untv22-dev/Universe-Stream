...
data class BackupData(
    ...
    val favorites: List<com.universestream.domain.model.Favorite>? = null,
    val virtualGroups: List<com.universestream.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.universestream.domain.model.Result<Unit>
