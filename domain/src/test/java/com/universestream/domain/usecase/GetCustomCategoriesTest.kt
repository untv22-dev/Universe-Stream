...
import com.universestream.domain.model.VirtualGroup
...
class GetCustomCategoriesTest {
    ...
    private class FakeChannelRepository(
        ...
        override fun getCategories(providerId: Long): Flow<List<com.universestream.domain.model.Category>> = error("Not used in test")
